...
class GlobalScalesTableSeeder extends Seeder
{
    ...
    protected $globalScales = [
        ...
        ['cbm' => 28, 'support_weight' => 8, 'max_weight' => 30, 'global_scale_rate' => 1500, 'description'=> 'A large plastic bag', 'description_mm' => 'ပလက်စတစ်ချင်းတောင်းကြီး', 'salt' => 450],
