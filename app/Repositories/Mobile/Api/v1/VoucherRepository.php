...
class VoucherRepository extends BaseRepository
{
    ...
    public function create(array $data)
    {
        ...
        $receiver = [
            ...
            'latitude' => isset($data['receiver_latitude']) ? $data['receiver_latitude'] : null,
            'longitude' => isset($data['receiver_longitude']) ? $data['receiver_longitude'] : null,
            'email' => isset($data['receiver_email']) ? $data['receiver_email'] : null,
        ];
        $voucher_id = 0;
        if (Voucher::count()) {
            ...
            foreach ($data['parcels'] as $key => $par) {
                ...
                if ($bus_station) {
                    ...
                    if ($sender_city_id != $receiver_city_id && $sender_city->branch && $receiver_city->branch && $merchant->static_price_branch > 0) {
                        ...
                        $data['weight'] = ($par['weight']) ? $par['weight'] : 1;
