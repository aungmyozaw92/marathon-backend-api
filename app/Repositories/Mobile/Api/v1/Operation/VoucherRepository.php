...
use App\Repositories\Mobile\Api\v1\Operation\AttachmentRepository;
...
class VoucherRepository extends BaseRepository
{
    ...
    public function calculate_atc_sender_receiver($payment_type_id, $total_item_price, $total_delivery_amount, $bus_fee, $total_extra_amount = 0)
    {
        switch ($payment_type_id) {
            ...
            case 4: //Nothing to collect
                return [
                    'sender_amount_to_collect' => 0, //$total_delivery_amount  + $bus_fee,
    ...
    public function change_store_status(Voucher $voucher): Voucher
    {
