...
class PickupCustomResource extends JsonResource
{
    ...
    public function toArray($request)
    {
            return [
                ...
                'sender_associate' => $this->when($this->sender_associate_id, MerchantAssociateCustomResource::make($this->sender_associate)),
