...
class ProductController extends Controller
{
    ...
    public function __construct(ProductRepository $productRepository, AttachmentRepository $attachmentRepository)
    {
        ...
        $this->middleware('can:delete,product')->only('create_review');
        $this->middleware('can:delete,product')->only('detail_review');
    ...
    {
        $products = Product::with('inventory','attachments','product_type','product_variations.variation_meta',
                                'product_tags','product_tags.tag','product_reviews','product_reviews.attachemnts')
    ...
    public function store(CreateProductRequest $request)
    {
        ...
        return new ProductResource($product->load(['inventory','attachments','product_type',
                                                'product_variations.variation_meta','product_tags','product_tags.tag']));
    }
    ...
    {
        return new ProductResource($product->load(['inventory','attachments','product_type','product_variations.variation_meta',
                                                    'product_tags','product_tags.tag','product_reviews','product_reviews.customer',
                                                    'product_reviews.attachemnts']));
    }
    ...
    public function update(UpdateProductRequest $request, Product $product)
    {
        ...
        return new ProductResource($product->load(['attachments','product_type','product_variations.variation_meta',
                                                'product_tags','product_tags.tag','product_reviews','product_reviews.attachemnts']));
    }
