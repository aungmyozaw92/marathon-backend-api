...
use App\Http\Requests\ThirdParty\CheckRouteRequest;
use App\Http\Resources\ThirdParty\City\CityCollection;
use App\Http\Resources\ThirdParty\Zone\ZoneCollection;
use App\Http\Requests\ThirdParty\DeliveryAmountRequest;
use App\Http\Resources\GlobalScale\GlobalScaleCollection;
use App\Http\Resources\PaymentType\PaymentTypeCollection;
use App\Http\Requests\ThirdParty\DeliveryAmountDetailRequest;
use App\Http\Resources\TrackingStatus\TrackingStatusCollection;
use App\Repositories\Web\Api\v1\ThirdParty\CalculateAmountRepository;
...
class HomeController extends Controller
{
    ...
    public function get_master_records()
    {
        ...
        //                     $q->where('is_deliver', '=', 1); // '=' is optional
        //                 })
        $cities = City::with(['zones' => function($q)  {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'tracking_statuses' => new TrackingStatusCollection($tracking_statuses),                
            ],
        ], 200);
    }
}
