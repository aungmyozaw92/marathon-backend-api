...
use App\Http\Resources\ThirdParty\Tag\TagCollection;
use App\Http\Requests\ThirdParty\Tag\CreateTagRequest;
use App\Http\Requests\ThirdParty\Tag\UpdateTagRequest;
use App\Repositories\Web\Api\v1\ThirdParty\TagRepository;
...
class TagController extends Controller
{
    ...
    {
        $tags = Tag::with('product_tags','product_tags.product')->where('merchant_id', auth()->user()->id)->filter(request()->only([
                    'name'
                ]));
    ...
    {
        return new TagResource($tag->load('product_tags','product_tags.product'));
    }
