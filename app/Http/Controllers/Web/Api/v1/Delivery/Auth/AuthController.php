...
namespace App\Http\Controllers\Web\Api\v1\Delivery\Auth;
...
class AuthController extends Controller
{
    ...
    public function profile()
    {
        ...
        return new StaffResource($staff->load(['department', 'zone', 'courier_type', 'hero_badge','daily_commission']));
    }
    ...
    protected function respondWithToken($token)
    {
        ...
        $staff =  new StaffResource($user->load(['department', 'zone', 'courier_type','hero_badge']));
        return response()->json([
            'status' => 1,
            'data' => [
                'access_token' => $token,
    ...
    public function update_password(UpdateProfileRequest $request)
    {
        $staff = $this->guard()->user();
