...
use App\Http\Resources\Mobile\Pickup\PickupResource;
use App\Repositories\Mobile\Api\v1\PickupRepository;
use App\Http\Resources\Mobile\Pickup\PickupCollection;
use App\Http\Requests\Mobile\Pickup\CreatePickupRequest;
use App\Http\Requests\Mobile\Pickup\UpdatePickupRequest;
...
class PickupController extends Controller
{
    ...
    public function show(Pickup $pickup)
    {
        ...
        return (new PickupResource($pickup->load([
            'vouchers', 'opened_by_staff', 'vouchers.parcels', 'vouchers.customer', 'vouchers.payment_type',
