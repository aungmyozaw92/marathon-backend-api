...
class MerchantTransactionHistoryForThirdpartySheet implements FromCollection, WithTitle, WithHeadings, WithMapping
{
    protected $id;
    ...
    {
        return 'MerchantTransactionHistoryForThirdparty';
    }
    ...
    {  
        ...
        if ($resource_type == 'Transaction') {
            ...
            $voucher_delivery_status = ($row->status)? 'Comfirmed' : 'Pending';
            $collected_amount = '-';
            $delivery_fee = '-';
            $delivery_date = '-';
            $pickup_date = '-';
            ...
            $receiver_name = ($voucher->receiver_name) ? $voucher->receiver_name : $voucher->receiver->name;
            $receiver_phone = ($voucher->receiver_phone) ? $voucher->receiver_phone : $voucher->receiver->phone;
